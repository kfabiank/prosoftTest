    ...
    function AddDays() {
        ...
        for (var i = 0; i < calendar.Selected.Days; i++) {
            ...
            for (var n = 0; n < calendar.Model.length; n++) {
                var tempDate = new Date(calendar.Model[n].date);


                var mystring = calendar.Model[n].date;
                var tempDate = mystring.replace(/-/g, ", ");
                var evDate = new Date(tempDate);
                ...
                if (evDate.getTime() == toDate.getTime()) {
                    ...
                    if (typeof calendar.Model[n].Link == 'function' || calendar.Options.EventClick) {
                        ...
                        title.innerHTML += '<a href="' + calendar.Model[n].Link + '">' + calendar.Model[n].name + '</a>';
                    }
